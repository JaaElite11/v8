/**
   * Create By Vander Store
   * Contact Me on wa.me/6289520169515
   * Follow https://github.com/JaaElite11
*/
...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                ALYA.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/772ee9271bc1342f30303.jpg' }, caption: `*Hai Kak ${m.pushName}*\n\n Bot Vander Prices\n◦ 5K Per Group via E-Walet Permanen\n◦ 10K via pulsa Permanen\n\n Premium Price Bot\n◦ 10k per User 1 bulan\n\nPayment can be via Paypal/link aja/pulsa\n\nFor more details, you can chat with the owner\nhttps://wa.me/6289520169515 (Owner)\n\nDonate For Me : \n\n◦ Paypal : https://www.paypal.me/\n◦ Saweria : https://saweria.co/` }, { quoted: m })
            }
            break
            case 'rules':{
...
break
	        ...
	        anu = `
◦ Script : https://github.com/minta owner
◦ Script ori : https://github.com/minta owner

Jangan lupa kasih bintang.
◦ Donate : Minta Owner (Dana / gopay)
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://github.com/Minta Owner Kalau Hoki'
                                }
                            }]
...
rows: [
{title: "MENU GRUP", rowId: `menugc`, description: ``},
{title: "MENU DOWN", rowId: `menudown`, description: ``},
{title: "MENU SEARC", rowId: `menusearch`, description: ``},
{title: "MENU OWNER", rowId: `menuner`, description: ``},
{title: "MENU STICKER", rowId: `menucon`, description: ``},
]
},
]
ALYA.sendListMsg(m.chat, `Sistem otomatis (Bot WhatsApp) yang dapat membantu untuk melakukan sesuatu, mencari dan mendapatkan data/informasi hanya melalui Whatsapp`, '', '', `Klik Varian Menu`, sections, loh)
}
break
case 'menugc':{
var no = 1
